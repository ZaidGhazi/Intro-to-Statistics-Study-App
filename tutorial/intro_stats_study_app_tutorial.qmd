...
The public GitHub repository intentionally excludes raw textbook PDFs, extracted textbook figures, extracted source text, local vector indexes, runtime databases, `.Renviron`, and source-derived topic-evidence files. Those assets may exist in a local proof-of-concept workspace, but they are ignored because they can contain copyrighted or private course material. A fresh clone still demonstrates the app code, question-bank schema, visual architecture, audits, and tutorial; textbook-backed retrieval assets should be rebuilt locally from permission-cleared sources.
