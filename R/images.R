...
default_recreated_visual_metadata <- function() {
  tibble(
    ...
    chapter = c(2L, 2L, 1L, 1L, 4L, 3L, 15L, 14L, 11L),
...
default_recreated_visual_metadata <- function() {
  tibble(
    ...
    module_id = c(
      "module_1", "module_1", "module_1", "module_1", "module_2", "module_5",
      "module_8", "module_7", "module_6", "module_5", "module_3", "module_2",
      "module_2", "module_9"
    ),
    topic_id = c(
      "descriptive_stats", "descriptive_stats", "data_graphs", "data_graphs",
      "relationships_regression", "normal_dist", "ht_foundations", "ci_prop",
    ...
    concept_tag = c(
      ...
      "association", "z_score_interpretation", "p_value_interpretation", "margin_of_error",
    ...
    source_type = "recreated_visual",
    chapter = c(2L, 2L, 1L, 1L, 4L, 3L, 15L, 14L, 11L, 13L, 9L, 6L, 5L, 19L),
    section = NA_character_,
    page_number = NA_integer_,
    caption = c(
      "Recreated right-skewed distribution showing mean and median",
